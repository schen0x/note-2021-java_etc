...
*** TODO SeImpersonate Internal && AV Bypassing (fs)
    + info:
      - the SeImpersonate privilege escalation
    + target:
      - [[https://github.com/ohpe/juicy-potato]] 
        
*** Impersonate_token
    + info:
      - meterpreter incognito module, SYSTEM -> Admin
    + src:
    #+begin_src meterpreter
C:\Windows\system32>exit
meterpreter > use incognito
...
*** PWK cp24, windows 
    ...
    - Check the Jenkins documentation -> code execution -> download payload -> reverse shell (jenkinsuser, Domain Admins)
