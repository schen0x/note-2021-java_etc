...
TODO windows script to restart service
...
** TODO list
  ...
  TODO SQL
  TODO BO ref:
    - [[https://www.vulnhub.com/entry/brainpan-1,51/][brainpan]]
    - [[https://github.com/justinsteven/dostackbufferoverflowgood][dostackbufferoverflowgood]]
  TODO report env, pandoc

16th TODO identify bad chars, ref: [[https://github.com/gh0x0st/Buffer_Overflow][Buffer Overflow guide]]
16th TODO EIP, pattern identify && offset script, p461
  - pattern_create.rb -l 600 identify eip
  - pattern_offset.rb -q ...
17th TODO PWK p460 JMP ESP and Return Address
