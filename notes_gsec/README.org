...
**** Mimikatz
     + to avoid dection:
       - run directly from memory use injector like Powershell.
       [[https://github.com/PowerShellMafia/PowerSploit/blob/master/CodeExecution/Invoke-ReflectivePEInjection.ps1]] 

       - dump the entire LSASS process memory use bbuilt-in tool like Task Manager, then analysis the dump in a helper machine.
