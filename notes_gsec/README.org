...
*** IP in Action, basic routing table
    ...
    + each network have a different ip address(interface): in this case, a loopback network(this machine) and a local network connection using two different interface
